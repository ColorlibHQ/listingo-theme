...
// image default alt
if ( ! function_exists( 'listingo_img_default_alt' ) ) {
	function listingo_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'listingo_img_tag' ) ) {
	function listingo_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = listingo_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'listingo_anchor_tag' ) ) {
	function listingo_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'listingo_heading_tag' ) ) {
	function listingo_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'listingo_paragraph_tag' ) ) {
	function listingo_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'listingo_other_tag' ) ) {
	function listingo_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'listingo_button_element ' ) ) {
	function listingo_button_element( array $args ) {
