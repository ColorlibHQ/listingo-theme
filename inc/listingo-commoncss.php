...
// enqueue css
function listingo_common_custom_css(){
    
    wp_enqueue_style( 'listingo-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= listingo_opt( 'listingo_theme_color' ) != '#131313' ? listingo_opt( 'listingo_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= listingo_opt( 'listingo_book_btn_color' ) != '#131313' ? listingo_opt('listingo_book_btn_color') : '';
		$bookBtnHoverBgColor     	= listingo_opt( 'listingo_book_btn_hvr_bg_color' ) != '#131313' ? listingo_opt('listingo_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = listingo_opt( 'listingo_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = listingo_opt( 'listingo_navbar_bg_color' ) != '#082b49' ? listingo_opt( 'listingo_navbar_bg_color') : '';
		$headerTop_col     		  = listingo_opt( 'listingo_top_header_color' );

		$headerTopBg      		  = listingo_opt( 'listingo_top_header_bg_color');
		$headerBg          		  = listingo_opt( 'listingo_header_bg_color') != '#ffffff' ? listingo_opt( 'listingo_header_bg_color') : '';
		$menuColor          	  = listingo_opt( 'listingo_header_menu_color' ) != '#131313' ? listingo_opt('listingo_header_menu_color') : '';
		$menuHoverColor           = listingo_opt( 'listingo_header_menu_hover_color' ) != '#808080' ? listingo_opt('listingo_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = listingo_opt( 'listingo_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = listingo_opt( 'listingo_header_drop_menu_bg_color' ) != '#ffffff' ? listingo_opt('listingo_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = listingo_opt( 'listingo_dropdown_menu_color' ) != '#131313' ? listingo_opt('listingo_dropdown_menu_color') : '';
		$dropMenuHovColor         = listingo_opt( 'listingo_dropdown_menu_hover_color' ) != '#808080' ? listingo_opt('listingo_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = listingo_opt( 'listingo_footer_widget_bg_color' );
		$footerwHeadColor   	  = listingo_opt('listingo_footer_widget_heading_color');
		$footerwTextColor   	  = listingo_opt('listingo_footer_widget_text_color');
		$footerwanchorcolor 	  = listingo_opt('listingo_footer_widget_anchor_color') != '#ffffff' ? listingo_opt('listingo_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = listingo_opt('listingo_footer_widget_anchor_hover_color') != '#ffffff' ? listingo_opt('listingo_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = listingo_opt('listingo_fof_bg_color');
		$foftonecolor			  = listingo_opt('listingo_fof_textone_color');
		$fofttwocolor			  = listingo_opt('listingo_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = listingo_opt('listingo_footer_widget_anchor_color') != '#9e9e9e' ? listingo_opt('listingo_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .listingo_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .listingo_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'listingo-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'listingo_common_custom_css', 50 );